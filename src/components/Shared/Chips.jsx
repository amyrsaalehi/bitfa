...
export default function Chips({ title, color = "base", noplus = false }) {
  if (color === "base")
    return (
      <div className="flex justify-center items-center gap-1 max-w-fit px-4 py-2 rounded-3xl transition-colors bg-base-300 hover:bg-base-200 cursor-pointer">
        <p className="text-sm text-base-content/70 -mb-0.5">{title}</p>
        {!noplus ? (
