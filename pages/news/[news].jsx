...
export default function ArticleDetailsPage() {
  ...
  return (
    <Layout title={article}>
      <div className="relative container flex flex-col gap-2 py-24">
        <div className="flex gap-2 justify-end">
          <p className="badge p-3 text-sm">بایننس</p>
        ...
        <div className="breadcrumbs mt-2">
          <ul>
            ...
            <li>
              <Link href="/articles">اخبار</Link>
            </li>
            <li className="text-base-content/60">
              پیش‌بینی‌های مدیرعامل بایننس
            </li>
          </ul>
        </div>
        ...
        <div className="flex flex-col gap-8 mt-8">
          <p className="leading-8 text-justify">
            ...
            مشابه پاسخ می‌دهیم. سپس، به بررسی فرآیندهای ایجاد کریپتو، استخراج
            آن، کیف پول کریپتو، صرافی کریپتو و نحوه خرید و فروش کریپتو
            می‌پردازیم.
          </p>
        ...
        <div className="flex flex-col gap-4 mt-8 rounded-3xl">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-4">
            <NewsCard
              image={ArticleImage}
              title={"پیش‌بینی‌های مدیرعامل بایننس؟"}
            />
            <NewsCard
              image={ArticleImage}
              title={"پیش‌بینی‌های مدیرعامل بایننس؟"}
